...
<body>
	...
	<p>
		...
		&lt;fmt:formatNumber value="출력할 값" groupingUsed="true/false" type="precent/currency" currencySymbol="$" /&gt;<br>
	</p>
	...
	일반 출력시 : ${num1} <br>
	세자리마다 구분해서 출력하고 싶으면 : <fmt:formatNumber value="${num1 }"/>
	...
	<!-- 
		currency : 통화(돈)단위로 보여짐. 현재 내 컴퓨터의 로컬 정보에따라 통화기호가 결정됨
