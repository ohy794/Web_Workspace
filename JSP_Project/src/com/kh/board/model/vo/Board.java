...
public class Board {
	...
	private String boardWriter; // boardWriter 작성시 회원번호(user_no), 조회시 회원아이디(user_id)를 저장
	private int count;
	...
	public void setTitieImg(String titieImg) {
		this.titieImg = titieImg;
	}
	...
	public String toString() {
		return "Board [boardNo=" + boardNo + ", boardType=" + boardType + ", category=" + category + ", boardTitle="
				...
				+ ", createDate=" + createDate + ", status=" + status + ", titieImg=" + titieImg + "]";
	}
