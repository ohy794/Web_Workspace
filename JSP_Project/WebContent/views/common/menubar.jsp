...
<body>
	<script>
		...
		if(msg != "null"){ // 성공적으로 로그인이 되었습니다 / null
			...
			// 안그러면 menuber.jsp가 로딩 될때마다 매번 alert함수가 실행됨
	...
	<div class="login-area">
		...
		<script>
			function enrollPage(){
				...
				// 웹 에플리케이션의 디렉토리 구조가 url에 노출되면 보안에 취약
				
				// 단순한 적정인 페이지 이동요청이라고해도 반드시 servlet을 거쳐갈것 => url에 서블릿 매핑값만 노출되로록하기
	...
	<div class="nav-area" align="center">
		...
		<div class="menu"><a href="<%= contextPath %>/list.bo?currentPag3=1">일반게시판</a></div>
